...
export function introAni() {
    ...
    ani.set(".intro__popup>.bgSlider>.bgSliderWrap", { width: "100%" });

    ani.fromTo(".intro__popup>.mainSlider>.mainSlider__center>.center__text>.titleSlider>.titleWrap", { y: 72, opacity: 0 }, { y: 0, opacity: 1, duration: 1 })
        .fromTo(".intro__popup>.mainSlider>.mainSlider__center>.center__img", { scale: 1 }, { scale: 0.5, duration: 2, ease: "power1.inOut" })
        .to(".intro__popup>.mainSlider>.mainSlider__center>.center__img", { scale: 0.6, duration: 3, ease: "power1.inOut" })
        .to(".intro__popup>.mainSlider>.mainSlider__center>.center__img", { width: 250, height: 410, scale: 1, duration: 3, ease: "power1.inOut" })
        .fromTo(".intro__popup .mainSlider", { width: "100%" }, { width: "80%" })
        .to(".intro__popup>.mainSlider>.mainSlider__center>.center__text>.titleSlider>.titleWrap>h2", { y: -72 })
        .to(".intro__popup>.mainSlider>.mainSlider__center>.center__text", { xPercent: -200, opacity: 0, duration: 1, ease: "power1.inOut" })
        .to(".intro__popup>.mainSlider>.mainSlider__center>.center__text", { textAlign: "left", position: "relative", top: "auto", left: "auto", y: 0, x: 0, xPercent: 0, yPercent: 0, })
        .to(".intro__popup>.mainSlider>.mainSlider__center>.center__text", { opacity: 1 })
        .fromTo(".intro__popup>.mainSlider>.mainSlider__center>.center__text>.descSlider>.descWrap", { y: 24, opacity: 0, visibility: "hidden" }, { y: 0, opacity: 1, visibility: "visible", duration: 1, ease: "power1.inOut" })
        .fromTo([".intro__popup .mainSlider__top", ".intro__popup .mainSlider__bottom"], { display: "none" }, { display: "flex" })
        .to(".intro__popup>.mainSlider>.mainSlider__center", { height: "60%" })
    ...
    gsap.set(".intro__popup>.mainSlider>.mainSlider__center>.center__img>.centerSliderWrap", { display: "flex", width: "600%", height: "100vh" });
    gsap.set(".intro__popup>.mainSlider>.mainSlider__center>.center__img>.centerSliderWrap>.centerSlider", { xPercent: 100, opacity: 0 });
